  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full">
        <MaskContainer
          revealText={
            <p className="text-center text-lg sm:text-2xl md:text-4xl font-semibold text-slate-800 dark:text-white leading-7 sm:leading-[3rem]" style={{ fontFamily: 'Arial-BoldMT, Arial, sans-serif' }}>
              <span className="bg-gradient-to-r from-blue-400 to-blue-700 bg-clip-text text-transparent text-3xl sm:text-6xl font-extrabold leading-[8rem] sm:leading-[6rem] md:leading-[10rem]" style={{ fontFamily: 'Arial-BoldMT, Arial, sans-serif' }}>Welcome to Aro Cafe</span><br/>
          ...
          className="min-h-[20rem] sm:min-h-[24rem] md:h-[40rem] rounded-md text-white text-base sm:text-xl md:text-2xl lg:text-4xl dark:text-black px-2 sm:px-8 py-4"
        >
