...
export default function AboutSection() {
  ...
  return (
    <div
      ref={sectionRef}
      className="relative flex min-h-[30rem] sm:min-h-[30rem] md:min-h-screen h-auto w-full items-center justify-center overflow-hidden px-2 sm:px-0 bg-white dark:bg-slate-900 z-10"
    ...
    >
      ...
      <div className="relative z-10 w-full">
        <MaskContainer
          revealText={
            <p className="text-center text-lg sm:text-xl md:text-2xl lg:text-3xl md:max-w-6xl font-semibold text-slate-800 dark:text-white leading-7 sm:leading-[2.6rem]" style={{ fontFamily: 'Arial-BoldMT, Arial, sans-serif' }}>
          ...
          className="min-h-[20rem] sm:min-h-[28rem] md:h-[40rem] rounded-md text-white text-base sm:text-xl md:text-2xl lg:text-4xl dark:text-black px-2 sm:px-8 py-4"
        >
